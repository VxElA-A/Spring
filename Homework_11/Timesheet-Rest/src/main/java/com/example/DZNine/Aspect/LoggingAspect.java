...
//     */
//
//    @Pointcut("@annotation(com.example.DZTen.Aspect.Logging)")
//    public void loggingMethodsPointcut() {
//
//    }
//
//    @Pointcut("@within(com.example.DZTen.Aspect.Logging)")
//    public void loggingTypePointcut() {
//
//    }
//
//    @Around(value = "loggingMethodsPointcut()MethodsPointcut() || loggingTypePointcut()")
